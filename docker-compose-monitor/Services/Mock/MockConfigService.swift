...
struct MockedData {
    static func fetchConfigs() -> Array<Config> {
        let config1 = Config(name: "PROD", host: "192.168.2.3", username: "username", publicKey: "path_to_key", privateKey: "path_to_key", containers: fetchContainersProd())
        let config2 = Config(name: "BETA", host: "192.168.2.3", username: "username", publicKey: "path_to_key", privateKey: "path_to_key", containers: fetchContainersBeta())
        let config3 = Config(name: "DEV", host: "192.168.2.3", username: "username", publicKey: "path_to_key", privateKey: "path_to_key", containers: fetchContainersDev())
